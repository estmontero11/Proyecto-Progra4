...
function enviar() {
    var punt= document.getElementById("count").innerHTML;
    if (validar()) {
        //Se envia la información por ajax
        $.ajax({
            url: 'ServiciosServlet',
            data: {
                accion: $("#retroAction").val(),
                idRetro: $("#idRetro").val(),
                puntuacion: punt,
            ...
            success: function (data) { //si todo esta correcto en la respuesta del ajax, la respuesta queda en el data
                ...
                if (tipoRespuesta === "C~") { //correcto
                    swal('Correcto',"Agradecemos su interés por ayudarnos a ser mejores", 'success');
                } else {
        ...
        swal('Error', 'Debe digitar todos los campos del formulario', 'error');
    }
}
